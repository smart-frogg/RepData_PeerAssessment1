...
We are seeing a clear maximum at **`r timeMaxAxtivityHour`:`r timeMaxAxtivityMinutes`** five-minutes interval. In peak we observe value **`r maxActivity`**. It is **`r maxActivityPerMinute`** steps in a minute.
